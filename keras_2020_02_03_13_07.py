...
result_dir = "./results/"
with open(dataset_dir+"1_108_8x9_dataset_3D_win_10_normalize_False_overlap_True.pkl", "rb") as fp:
    dataset = pickle.load(fp)
with open(dataset_dir+"1_108_8x9_label_3D_win_10_normalize_False_overlap_True.pkl", "rb") as fp:
...
def model(input_shape):
    ...
    # rnn_output = LSTM(unitpys=1024, return_sequences=False, unit_forget_bias=True)(lstm_1)
...
if confirm == "y":
    ...
    with open(results_path + "/readme.txt", "w") as file:
        file.write("Training data: 1-108 75%, 14 channels, 6x8, shuffle=True,\n")
        file.write("Validation data: 1-108 25%, 14 channels, 6x8, shuffle=True,\n")
        file.write("normalize=False, overlap=True,\n")
        file.write("One-hot encoded,\n")
        file.write("Normalization StandardScaler, per channels,\n")
