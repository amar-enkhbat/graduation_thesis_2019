...
with open(dataset_dir+"1_108_2x4_dataset_3D_win_10_normalize_False_overlap_False.pkl", "rb") as fp:
    dataset = pickle.load(fp)
with open(dataset_dir+"1_108_2x4_label_3D_win_10_normalize_False_overlap_False.pkl", "rb") as fp:
    labels = pickle.load(fp)
# with open(dataset_dir+"1_2_2x4_dataset_3D_win_10_normalize_False_overlap_False.pkl", "rb") as fp:
#     dataset = pickle.load(fp)
# with open(dataset_dir+"1_2_2x4_label_3D_win_10_normalize_False_overlap_False.pkl", "rb") as fp:
#     labels = pickle.load(fp)
