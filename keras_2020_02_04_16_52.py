...
result_dir = "./results/"
with open(dataset_dir+"1_108_3x6_dataset_3D_win_10_normalize_False_overlap_True.pkl", "rb") as fp:
    dataset = pickle.load(fp)
with open(dataset_dir+"1_108_3x6_label_3D_win_10_normalize_False_overlap_True.pkl", "rb") as fp:
