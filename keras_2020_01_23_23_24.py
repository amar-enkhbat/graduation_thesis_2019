...
def model(input_shape):
    ...
    gru_1 = Bidirectional(GRU(units=recurrent_units, return_sequences=True, dropout=dropout_prob, recurrent_dropout=recurrent_dropout_prob))(lstm_in)
    gru_2 = Bidirectional(GRU(units=recurrent_units, return_sequences=True, dropout=dropout_prob, recurrent_dropout=recurrent_dropout_prob))(gru_1)
    rnn_output = Bidirectional(GRU(units=recurrent_units, return_sequences=False, dropout=dropout_prob, recurrent_dropout=recurrent_dropout_prob))(gru_2)
...
if confirm == "y":
    ...
    with open(results_path + "/readme.txt", "w") as file:
        ...
        file.write("recurrent_dropout_prob = 0.2,\n")
