...
def data_1Dto2D(data, Y, X):
	...
	if Y == 1:
		...
		data_2D[0] = ( 	   	 0,  	   	 0, 	   0, data[21], data[22], data[23], 	   0,  	     0, 	   0) 
		data_2D[1] = (data[29],          0, data[31],        0, data[33],        0, data[35],        0, data[37]) 
		data_2D[2] = (       0,    data[0],        0,  data[2],        0,  data[4],        0,  data[6],        0) 
		data_2D[3] = (data[40],          0,  data[8],        0, data[10],        0, data[12],        0, data[41]) 
		data_2D[4] = (       0,   data[14],        0, data[16],        0, data[18],        0, data[20],        0) 
		data_2D[5] = (data[46],          0, data[48],        0, data[50],        0, data[52],        0, data[54]) 
		data_2D[6] = (	     0, 	 	 0,        0,        0, data[57],        0,        0, 	   	 0, 	   0) 
		data_2D[7] = (	     0, 	 	 0, 	   0, data[60], data[61], data[62], 	   0, 	   	 0, 	   0) 
	else:
