...
X_valid = scaler.fit_transform(X_valid.transpose())
X_train = X_train.transpose().reshape(-1, window_size, height, width, 1)
X_valid = X_valid.transpose().reshape(-1, window_size, height, width, 1)
...
if confirm == "y":
    ...
    with open(results_path + "/readme.txt", "w") as file:
        ...
        file.write("Normalization StandardScaler, individual blocks,\n")
